...
describe("CASH PO", function(){
    ...
    it("visit", function(){
        ...
        cy.xpath("//select[@name='purchase_base']").select('Notesheet')  //Purchase base
        cy.wait(1000)
        cy.xpath("(//input[@autocomplete='off'])[1]").type('CCDL/2023/NS')   //NS no
        cy.xpath("(//input[@autocomplete='off'])[1]").type('{Enter}')   //NS no
        cy.wait(1000)
        cy.xpath("(//input[@autocomplete='off'])[11]").type('Main Plant')   //cost head 
        cy.wait(1000)
        cy.xpath("(//input[@autocomplete='off'])[11]").type('{Enter}')   //cost head  
        cy.wait(1000)
