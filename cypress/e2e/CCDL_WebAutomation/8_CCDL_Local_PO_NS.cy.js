...
describe("CASH PO", function(){
    ...
    it("visit", function(){
        ...
        cy.wait(1000)
        cy.xpath("(//input[@autocomplete='off'])[2]").type('CCDL/2023/NS')   //NS no
        cy.xpath("(//input[@autocomplete='off'])[2]").type('{Enter}')   //NS no
        cy.wait(1000)
        cy.xpath("(//input[@autocomplete='off'])[5]").type('Main Plant')   //cost head 
        cy.wait(1000)
        cy.xpath("(//input[@autocomplete='off'])[5]").type('{Enter}')   //cost head  
        cy.wait(1000)
