describe("Local-PO(Agrmt)", function(){
    it('visit', function(){
        ...
        cy.wait(1000)
        cy.get("#partner_id").type('{downArrow}{downArrow}{Enter}')     //vendor select
        ...
        cy.wait(1000)
        cy.get("table[class='o_section_and_note_list_view o_list_table table table-sm table-hover position-relative mb-0 o_list_table_ungrouped table-striped']>tbody>tr:nth-child(2)>td:nth-child(4)").type('25')
        cy.wait(1000)
